...
export const SMALT = '#007FCE'
export const NAVY_BLUE = '#0066FF'
export const KOURNIKOVA = '#F7CD4B'
export const WISTERIA = '#c38fff'
export const NERO = '#1e1e1e'
export const ROBINS_EGG_BLUE = '#00dac6'
export const BACKGROUND_BLACK = '#272525'
export const SUMMER_SKY = '#42A5F5'
